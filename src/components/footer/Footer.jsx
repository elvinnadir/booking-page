        ...
        <div className='footer'>
            <div className="footer_lists">
                ...
                <ul className="footer_list">
                    ...
                    <li className="footer_list_item">Travel Agents </li>
                </ul>

                <ul className="footer_list">
                    <li className="footer_list_item">Curtomer Service</li>
                    <li className="footer_list_item">Partner Help</li>
